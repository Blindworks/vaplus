...
function reloadEventSources(){
			...
			$('.calendar3').each(function(){
				...
				var tmp = new Object();
				var ownderId;
				tmp['url'] = '/sockets/calendar/fullCalendar3.json';
				tmp['editable'] = $(this).data('editable');
...
function submitCalendarSaveEvent(data){
		...
		function refreshCalendarDateElement(){
			$('h2.calendarDuration').text($('.calendar3').first().fullCalendar('getView').title);
    	...
    	function initSingleCalendar(calendarId, ownerId, viewStyle,calEditable,fromArray,toArray,askForEventType, defaultView, eventLimit){
    		...
    		console.log("initSingleCalendar");
    		...
    		$(calendarId).fullCalendar({
	            ...
	            eventReceive : function( event ) { 
	            	...
	            	console.log("eventReceive "+(new Date()).getTime() );
	            	...
	            	console.log("eventReceive FIRE FORM"+(new Date()).getTime() );
					...
					if(askForEventType){
		            	...
		            	console.log("#eventModalForm\\:saveEventBtn");
						$('#eventModalForm\\:saveEventBtn').click();
					}
					
					this.calendar.updateEvent(event);

	            	console.log("eventReceive DONE FORM"+(new Date()).getTime() );
	            },
	            ...
	            eventDrop: function(event, delta, revertFunc) {
	            	...
	            	console.log("fire eventForm\\:updateEventBtn");
	            ...
	            eventClick: function(event, jsEvent, view) {
			  	...
			  	eventRender: function(event, element, view) {
				    ...
				    element.addClass('color-'+event.colorName);
